...
public:
    ...
    virtual bool RemoveTagsFromAgent(const RemoveTagsFromAgentRequest& request,
                                     RemoveTagsFromAgentResponse* response) = 0;
    ...
    //Freeze
    virtual bool FreezeAgent(const FreezeAgentRequest& request, FreezeAgentResponse* response) = 0;
    virtual bool ThawAgent(const ThawAgentRequest& request, ThawAgentResponse* response) = 0;
